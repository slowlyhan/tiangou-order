package com.tiangou.order.service.impl;
...
import com.tiangou.mapper.TbOrderItemMapper;
import com.tiangou.mapper.TbOrderMapper;
import com.tiangou.mapper.TbOrderShippingMapper;
import com.tiangou.order.component.JedisClient;
...
public class OrderServiceImpl implements OrderService {
	...
	public TiangouResult createOrder(OrderInfo orderInfo) {
		...
		// 返回TaotaoResult包装订单号。
		return TiangouResult.ok(orderId);
	}
